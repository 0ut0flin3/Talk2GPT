...
**fixed the installation bug (on Windows) related to PyGame. now pygame won't be automatically installed when you use pip, this allows you to install gptalk successfully, you can install pygame separately if you want to use speech, on Linux there are no installation bugs instead**
